 ...
 *          its been modified to a template class
 *
 */
...
template <class T>
void SortingList<T>::selection_sort(int (*compare)(const T& b1, const T& b2))
{
    size_t min_index = 0;
...
template <class T>
void SortingList<T>::bubble_sort(int (*compare)(const T& b1, const T& b2))
{
...
template <class T>
void SortingList<T>::merge_sort(int (*compare)(const T& b1, const T& b2))
{
...
// helper functions
template <class T>
void SortingList<T>::merge(int first, int mid, int last, int (*compare)(const T& b1, const T& b2))
{
...
template <class T>
void SortingList<T>::merge_sortHelper(int min, int max, int (*compare)(const T& b1, const T& b2))
{
    if (min < max)
    {
        int mid = (min + max) / 2;
